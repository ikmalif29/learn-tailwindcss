                ...
                <div className="mx-auto mt-8 max-w-xl">
                    <form action="#" className="sm:flex sm:gap-4">
                        <div className="sm:flex-1">
                            ...
                            <input
                                type="text"
                                placeholder="Product apa yang anda cari"
                                className="w-full rounded-md border-gray-200 bg-white p-3 text-gray-700 shadow-sm transition focus:border-white focus:outline-none focus:ring focus:ring-indigo-600"
                            />
                        </div>
                        ...
                        >
                            <span className="text-sm font-medium"> Cari Product </span>
                        </button>
                    </form>
                </div>
            </div>
